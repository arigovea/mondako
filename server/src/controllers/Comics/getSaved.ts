...
export default (req: Request, res: Response) => {
  ...
  con.query(`SELECT saved.id_comic, comic.image_url, user.*, country.country_url FROM saved
  INNER JOIN user ON user.id_user = saved.id_user
  INNER JOIN comic ON saved.id_comic = comic.id_comic 

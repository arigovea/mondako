...
CREATE TABLE `saved` (
  ...
  KEY `id_user` (`id_user`),
  CONSTRAINT `saved_ibfk_1` FOREIGN KEY (`id_comic`) REFERENCES `comic` (`id_comic`),
  CONSTRAINT `saved_ibfk_2` FOREIGN KEY (`id_user`) REFERENCES `comic` (`id_user`)
...
INSERT INTO `saved` VALUES (1,4),(1,21),(1,22),(1,16);
